...
{ urlButton: { displayText: `OWNER`, url: `https://wa.me/6287778405247`}},
...
mentions: [sender],
footer: fake,
buttonText: 'List Button By Vynaa Chan',
sections: seactions,
listType: 1}
...
owned = '6287778405247@s.whatsapp.net'
ngen = `
Title : ${anu.title}
Ext : Search
ID : ${anu.videoId}
...
fromMe: false,
participant: `0@s.whatsapp.net`,
remoteJid: "6287778405247-1626053991@g.us"
},
message: {
orderMessage: {
itemCount: 99999999,
...
let e = String(err)
kayla.sendMessage("6285298205726@s.whatsapp.net", { text: "Hallo Owner Sepertinya Ada Yang Error Harap Di Perbaiki " + util.format(e), 
contextInfo:{
forwardingScore: 5, 
isForwarded: true
}})
